      ...
      <section class="briefing-overlay" id="briefing-overlay" role="dialog" aria-modal="true" aria-labelledby="briefing-title" aria-describedby="briefing-copy" hidden>
        <article class="briefing-ticket">
          ...
          <section class="degen-guide" id="briefing-degen-panel" role="tabpanel" aria-labelledby="briefing-degen" hidden>
            ...
            <ol class="degen-steps"><li><span class="degen-icon" aria-hidden="true"><img src="/manus-storage/degen-daily-cache-button_74ced788.png" alt=""></span><div><b>PUSH BUTTON.</b><small>GET DAILY. 250.</small></div></li><li class="degen-arrow" aria-hidden="true">↓</li><li><span class="degen-icon" aria-hidden="true"><img src="/manus-storage/degen-waiver-button_92607b99.png" alt=""></span><div><b>PUSH OTHER BUTTON</b><small>PAY 100 CHIPS. JOIN ROUND.</small></div></li><li class="degen-arrow" aria-hidden="true">↓</li><li><span class="degen-icon degen-bomb" aria-hidden="true"><img src="/manus-storage/degen-pass-bomb-button_9ef0d78c.png" alt=""></span><div><b>PASSING BOMB WILL<br>COST YOU A LITTLE</b><small>SPLODING WILL COST YOU EVERYTHING.</small></div></li></ol>
