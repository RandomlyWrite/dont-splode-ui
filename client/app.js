...
(() => {
    ...
    <div class="shell">
      ...
      <section class="cabinet" data-local-holder="false" aria-label="Dont Splode game cabinet">
        <header class="marquee">
          ...
          <div class="marquee-title"><span class="eyebrow">GROUP GAME / 100 VIRTUAL CHIPS</span><h1 class="wordmark">DON'T SPLODE</h1></div>
      ...
      <section class="briefing-overlay" id="briefing-overlay" role="dialog" aria-modal="true" aria-labelledby="briefing-title" aria-describedby="briefing-copy" hidden>
        <article class="briefing-ticket">
          ...
          <section class="degen-guide" id="briefing-degen-panel" role="tabpanel" aria-labelledby="briefing-degen" hidden>
            ...
            <ol class="degen-steps"><li><span class="degen-icon" aria-hidden="true"><img src="./assets/degen-daily-cache-button-v2.png" alt=""></span><div><b>PUSH BUTTON.</b><small>GET DAILY. 250.</small></div></li><li class="degen-arrow" aria-hidden="true">↓</li><li><span class="degen-icon" aria-hidden="true"><img src="./assets/degen-waiver-button-v2.png" alt=""></span><div><b>PUSH OTHER BUTTON</b><small>PAY 100 CHIPS. JOIN ROUND.</small></div></li><li class="degen-arrow" aria-hidden="true">↓</li><li><span class="degen-icon degen-bomb" aria-hidden="true"><img src="./assets/degen-pass-bomb-button-v2.png" alt=""></span><div><b>PASSING BOMB WILL<br>COST YOU A LITTLE</b><small>SPLODING WILL COST YOU EVERYTHING.</small></div></li></ol>
  ...
  ui.secondaryActions = root.querySelector("#secondary-actions");
  ...
  ui.secondaryActions.append(ui.degenLobby);
  ...
  function render(nextState, event = null, eventBalance = null, eventDailyClaim = null, eventPitBoss = null, eventPitBossGrant = null) {
    ...
    ui.count.textContent = `${players.length}/12 IN`;
    ...
    if (phase === "running") {
      ...
      ui.holderBlock.dataset.state = localHolder ? "you" : "them";
      ui.holderKicker.textContent = localHolder ? "YOU HAVE THE BOMB" : "CURRENT FUSE";
      ui.holderName.textContent = localHolder ? "IT'S YOU" : (holder?.name || "Some poor soul").toUpperCase();
    } else {
      ui.holderBlock.hidden = true;
      ui.holderBlock.dataset.state = "none";
    }
    ...
    else if (phase === "lobby" && !isInLobby) ui.action.textContent = "SIGN THE WAIVER (NO REFUNDS) — 100 ◉";
